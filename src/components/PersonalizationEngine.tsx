...
const personalizationItems = [
  {
    ...
    description: "Identifies revenge trading, FOMO, and other emotional decision triggers."
  },
  {
    icon: "⚙️",
    title: "Adapts to Your Preferences",
    description: "Continually evolves as you accept or reject trading recommendations."
  },
  {
    icon: "📊",
    title: "Builds Unique Profile",
    description: "Creates a psychological and strategic profile that's uniquely yours."
  }
];

const PersonalizationEngine = () => {
  return (
    <section id="personalization" className="section-padding relative overflow-hidden">
      <div className="container mx-auto relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="mb-16 text-center">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 animate-reveal">
              <span className="gradient-text">AI</span> That Learns How You Trade
            </h2>
            <p className="text-lg text-white/70 max-w-2xl mx-auto animate-reveal animate-delay-200">
              TradeIQ adapts to your unique trading style, creating a personalized experience that evolves over time.
            </p>
          </div>
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 rounded-lg bg-navy-dark">
                    ...
                    <div className="w-32 h-2 bg-white/10 rounded-full overflow-hidden">
                      <div className="h-full bg-blue-soft rounded-full" style={{width: '65%'}}></div>
                    </div>
                  </div>
                  
                  <div className="flex justify-between items-center p-3 rounded-lg bg-navy-dark">
                    <span className="text-white/70">Trend Following</span>
                    <div className="w-32 h-2 bg-white/10 rounded-full overflow-hidden">
                      <div className="h-full bg-blue-soft rounded-full" style={{width: '80%'}}></div>
                    </div>
                  </div>
                  
                  <div className="flex justify-between items-center p-3 rounded-lg bg-navy-dark">
                    <span className="text-white/70">Reversal Trading</span>
                    <div className="w-32 h-2 bg-white/10 rounded-full overflow-hidden">
                      <div className="h-full bg-blue-soft rounded-full" style={{width: '30%'}}></div>
                    </div>
                  </div>
                  ...
                  <div className="flex justify-between items-center p-3 rounded-lg bg-navy-dark">
                    ...
                    <span className="text-white">EUR/USD, GBP/JPY</span>
                  </div>
                </div>
              </div>
            </div>
