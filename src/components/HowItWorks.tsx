...
const steps = [
  {
    ...
    description: "Seamlessly integrate with your existing broker or trading account."
  },
  {
    number: "02",
    title: "TradeIQ builds your behavioural profile",
    description: "Our AI analyzes your trading history to understand your style and patterns."
  },
  {
    number: "03",
    title: "Market & fundamental data analysed 24/7",
    description: "Continuous monitoring of global markets, news events, and technical patterns."
  },
  {
    number: "04",
    title: "Trades filtered through multi-layer logic",
    description: "Potential opportunities are verified against your profile and market conditions."
  },
  {
    number: "05",
    title: "You receive actionable alerts & coaching",
    description: "Get notified only when high-probability setups match your trading style."
  }
];
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto animate-reveal animate-delay-200">
            Our AI-powered platform follows a systematic approach to help you make informed trading decisions.
          </p>
        </div>
